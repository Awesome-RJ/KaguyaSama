...
class Config(object):
    ...
    # RECOMMENDED
    SQLALCHEMY_DATABASE_URI = 'postgres://bximsrqn:ur-I0OCAAz7ycArbHbf7K2wnwkzqFHHR@raja.db.elephantsql.com:5432/bximsrqn'  # needed for any database modules
